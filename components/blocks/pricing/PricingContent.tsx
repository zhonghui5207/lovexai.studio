  ...
  return (
    <>
      ...
      <div className="mb-8 sm:mb-12">
        <div className="flex flex-wrap items-center gap-6 sm:gap-8 border-b border-white/10 pb-0 mb-6 sm:mb-8">
          <button
        ...
        {activeTab === 'subscriptions' ? (
              ...
              {SUBSCRIPTION_PLANS.map((plan) => {
                ...
                return (
                  <div
                    ...
                    className={`relative p-4 sm:p-6 rounded-3xl border transition-all duration-300 flex flex-col cursor-pointer ${
                      isSelected
                  ...
                  >
                    ...
                    <Button
                      ...
                      className={`w-full py-5 sm:py-6 rounded-xl font-bold text-base transition-all ${
                        isSelected
          ...
          >
            <div className="mb-8 sm:mb-10">
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-2">Pay As You Go</h2>
              <p className="text-muted-foreground max-w-2xl">
            ...
            {/* Credits Usage Info */}
            <div className="mb-5 sm:mb-8 p-3 sm:p-4 rounded-2xl bg-white/5 border border-white/10">
              <h3 className="text-xs sm:text-sm font-bold text-white/60 mb-2 sm:mb-3">Credits Usage Reference</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4">
                {CREDITS_USAGE.map((item, i) => (
                  <div key={i} className="text-center">
                    <div className="text-white font-medium text-xs sm:text-sm">{item.action}</div>
                    <div className="text-primary text-[10px] sm:text-xs">{item.cost}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {CREDIT_PACKS.map((pack, index) => (
                <div
                  key={index}
                  className={`group relative overflow-hidden rounded-2xl bg-card border p-4 sm:p-6 hover:border-primary/50 transition-all duration-300 cursor-pointer ${
                ...
                >
                  ...
                  <div className="flex justify-between items-start relative z-10 gap-3">
                    <div>
                      ...
                      {pack.bonus > 0 && (
                        <div className="text-primary font-bold text-xs sm:text-sm mb-3 sm:mb-4">
                          +{pack.bonus.toLocaleString()} Bonus Credits!
                        </div>
                      )}
                      {!pack.bonus && <div className="h-4 sm:h-5 mb-3 sm:mb-4"></div>}
                    ...
                    {/* Coin Icon Visual */}
                    <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center shadow-lg shadow-yellow-500/20 group-hover:scale-110 transition-transform duration-300">
                  ...
                  {isLoading && processingId === pack.product_id ? (
                    <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4">
                      <Loader className="w-4 h-4 sm:w-5 sm:h-5 animate-spin text-primary" />
                    </div>
                  ) : (
                    <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 text-white/20 group-hover:text-primary transition-colors">
                      →
                    </div>
                  )}
                </div>
