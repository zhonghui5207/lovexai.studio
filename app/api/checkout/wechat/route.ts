...
export async function POST(req: Request) {
  console.log("WeChat Checkout API called");
  try {
    let {
      credits,
      currency,
    ...
    console.log("WeChat checkout params:", { product_id, amount, currency, interval });
    ...
    console.log("Creating order in Convex for WeChat payment...");
    ...
    console.error("WeChat checkout failed:", e);
